...
public class GetMenuItemsUseCaseTest extends BaseTest {
    ...
    @Mock protected DashboardItemsMenu dashboardItemsMenuMock;
    @Mock protected UserDemoEntity userDemoEntityMock;

    @Override public void setUp() {
        super.setUp();
        getMenuItemsUseCase = new GetMenuItemsUseCase(dashboardItemsMenuMock, UIMock);
    }

    @Test public void When_Execute_Get_Items_Menu() {
        TestSubscriber<List<ItemMenu>> subscriberMock = new TestSubscriber<>();
        getMenuItemsUseCase.react().subscribe(subscriberMock);
