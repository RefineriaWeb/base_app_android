...
public class GetSelectedDemoUserListUseCase extends UseCase<domain.sections.user_demo.UserDemoAgent> {
    @Inject public GetSelectedDemoUserListUseCase(domain.sections.user_demo.UserDemoAgent agent) {
        super(agent);
    }
